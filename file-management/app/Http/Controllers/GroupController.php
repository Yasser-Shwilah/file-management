...
class GroupController extends Controller
{
    ...
    public function removeFileFromGroup(AddFileToGroupRequest $request) 
    {
        try {
    ...
    public function removeUserFromGroup(AddUserToGroupRequest $request) 
    {
        try {
    ...
    public function removeGroup(DeleteGroupRequest $request) 
    {
        try {
